            ...
            <div class="p-3 py-5">
              ...
              if (!isset($_GET["questionID"]) || $_GET["questionID"] == "") {
                ...
                if (isset($_POST["editQuestion"])) {
                  ...
                  //ISSET POST - True or False Text Options
                  if (empty($_POST["editTrueOrFalseOption"])) {
                    $editTrueOrFalseOption = null;
                  } else {
                    $editTrueOrFalseOption = $_POST["editTrueOrFalseOption"];
                  }

                  //ISSET POST - True or False Select Correct Answer
                  if (!isset($_POST["editTrueOrFalseCorrect"])) {
                    $editTrueOrFalseCorrect = null;
                  } else {
                    $editTrueOrFalseCorrect = $_POST["editTrueOrFalseCorrect"];
                  }

                  if ($editQuestionTitle == ""|| $editTrueOrFalseOption == "" || $editTrueOrFalseCorrect == "") {
                    ...
                    if (
                      ...
                      for ($i = 0; $i < 2; $i++) { //Insert data for Option
                        if ($editTrueOrFalseCorrect == $i) {
                          DB::insert('option', [
                            'optionText' => $editTrueOrFalseOption[$i],
                            'optionCorrect' => 1,
                  ...
                  ?>
                    <div class="row d-flex justify-content-center align-items-center mt-30">
                      ...
                      <div class="col-lg-11 col-md-10 col-sm-10">
                        <input type="text" class="form-control must-fill true-or-false-option" name="editTrueOrFalseOption[]" id="editTrueOrFalseOption<?php echo $i + 1; ?>" value="<?php echo $queryDBOptionText; ?>" placeholder="Enter Option <?php echo $i + 1; ?>" readonly="readonly">
                      </div>
                      <div class="col-lg-1 col-md-2 col-sm-2 text-end">
                        <input class="form-check-input must-fill" type="radio" name="editTrueOrFalseCorrect" value="<?php echo $i; ?>" id="editTrueOrFalseCorrect<?php echo $i + 1; ?>" <?php
