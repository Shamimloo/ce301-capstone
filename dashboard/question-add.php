              ...
              if (isset($_POST["addQuestion"])) {
                ...
                if ($addQuestionType == 1) {
                  ...
                  if ($addQuestionTitle == "" ||  $addQuestionTime == "" || $correctImageOption == "" || $wrongImageOption == "" || $correctImageOption['file'] == null || $wrongImageOption['file'] == null) {
                    ...
                    if ($success) {
                      DB::commit();
                      sweetAlertTimerRedirect('Add Multi-Image Question', 'Question successfully added!', 'success', (SITE_URL . "question-summary"));
                    } else {
                      DB::rollback();
                      sweetAlertTimerRedirect('Add Multi-Image Question', 'An error occured. Please try again later.', 'error', (SITE_URL . "question-add"));
                    }
                  }
                }
              }
